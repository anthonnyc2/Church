...
function versionType(){
    if(version == 1){
        $('#verification').html('<h3>Paid Version</h3>')
        $('#verificationN').html('<h3>Paid Version</h3>')
        $('#verificationT').html('<h3>Paid Version</h3>')
        $('#verificationS').html('<h3>Paid Version</h3>')
        $('#verificationLL').html('<h3>Paid Version</h3>')
        $('#verificationLLD').html('<h3>Paid Version</h3>')
